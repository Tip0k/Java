...
public class Toys extends javax.swing.JFrame {
    ...
    /*
        ...
        try {
            //C:/Users/PEOPLE/Documents/NetBeansProjects/Java/Java/java_lab2/files/ToysDataBase.zip/ToysDataBase.txt
            File entry = new TFile("C:/Users/PEOPLE/Documents/NetBeansProjects/Java/Java/java_lab2/files/ToysDataBase.zip/ToysDataBase.txt");
        ...
        try {
            ...
            if (tempImage.equals("default")) {
                ...
                do {
                    ...
                    destImage = new File(getCurrentDirectory() + imageURL);
    ...
    private void showToyAndRepaint() {
        ...
        labPicture1.setIcon(new ImageIcon(new ImageIcon(getCurrentDirectory() + selectedToy.getPictureURL(),
